...
export default function CupCustomizer() {
  ...
  const updateTexture = (overlaysToRender = overlays) => {
    ...
    // Convert grey cup colors to white
    let fillColor = cupColor
    // Parse hex color to RGB
    const hex = cupColor.replace('#', '')
  ...
  useEffect(() => {
    const handleLoadDesign = (e) => {
      ...
      if (design.type !== 'cup') return
      
      // Load the design data
      setCupColor(design.colorHex || '#ffffff')
  ...
  const handleAddToCart = () => {
    ...
    const cartItem = {
      type: 'cup',
      price: 20.00,
      color: colorNames[cupColor] || 'Custom',
      colorHex: cupColor,
    ...
    <main style={{ 
      ...
      <div style={{ 
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', gap: '12px', padding: '12px', alignItems: 'center' }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ color: '#666', fontSize: '0.9rem' }}>Custom Cup · {cupColor}</div>
                </div>
          ...
          <div style={{
            ...
            <div 
              ...
              style={{
                ...
                aspectRatio: '1',
                cursor: 'crosshair',
                background: `url(/uv-maps/cup-uv.png)`,
            ...
            <div style={{
              ...
              Click and drag to position on cup
            </div>
          </div>
        )}
        ...
        <div style={{
          ...
          {itemSelectedMode ? 'Item selected - Click away to rotate cup' : '← Click and drag to rotate →'}
        </div>
      </div>
      ...
      <div style={{
          ...
          <div style={{
            ...
            {[
              ...
              <button
                ...
                onClick={() => setCupColor(colorOption.color)}
                style={{
                  width: '100%',
                  aspectRatio: '1',
                  background: colorOption.color,
                  border: `3px solid ${cupColor === colorOption.color ? '#000' : '#ddd'}`,
                  borderRadius: '8px',
                  cursor: 'pointer',
                  transition: 'all 0.2s ease',
                  boxShadow: cupColor === colorOption.color ? '0 0 0 2px #4db8ff' : 'none',
                }}
        ...
        >
          {overlays.length === 0 ? 'Add designs to continue' : 'Add to Cart - $20.00'}
        </button>
      </div>
